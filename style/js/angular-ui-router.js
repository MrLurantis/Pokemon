 ...
 * ### Angular 1:
 * ```js
 * TeacherApp.run($trace => $trace.enable());
 * ```
 *
 * @coreapi
 * @module trace
...
var UrlMatcherFactory = (function () {
     ...
     * @param definitionFn A function that is injected before the TeacherApp runtime starts.
 ...
 *
 * After a new instance of the UIRouter class is created, it should be configured for your TeacherApp.
 * For instance, TeacherApp states should be registered with the [[UIRouter.stateRegistry]].
 *
 * ---
 *
...
var StateService = (function () {
     ...
     * #### Example:
     * ```js
     * let TeacherApp angular.module('TeacherApp', ['ui.router']);
     *
     * TeacherApp.controller('ctrl', function ($scope, $state) {
     ...
     * #### Example:
     * ```js
     * //assuming TeacherApp application consists of 3 states: 'contacts', 'contacts.detail', 'contacts.detail.item'
 ...
 * nested states.
 *
 * The `$stateProvider` provides interfaces to declare these states for your TeacherApp.
 */
...
var UrlRouterProvider = (function () {
     ...
     * #### Example:
     * ```js
     * var TeacherApp = angular.module('TeacherApp', ['ui.router.router']);
     *
     * TeacherApp.config(function ($urlRouterProvider) {
     ...
     * })
     *
     * TeacherApp.run(function (MyService, $urlRouter, $http) {
 ...
 *     <a href ui-sref="TeacherApp.user({user: 'bilbobaggins'})">@bilbobaggins</a>
 *   </li>
 * </ul>
 * ```
 *
 * When the TeacherApp state is `TeacherApp.user` (or any child state),
 ...
 *     <a ui-sref="TeacherApp.user({user: 'bilbobaggins'})" href="/users/bilbobaggins">@bilbobaggins</a>
 *   </li>
 * </ul>
 * ```
 *
